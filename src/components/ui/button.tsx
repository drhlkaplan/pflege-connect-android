  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Pflege Connect Custom Variants
        hero: "pflege-gradient-cta text-white shadow-lg hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02] font-bold",
        "hero-outline": "border-2 border-white/30 bg-white/10 backdrop-blur-sm text-white hover:bg-white/20 hover:border-white/50",
        nurse: "pflege-gradient-nurse text-white shadow-md hover:shadow-lg hover:-translate-y-0.5",
        company: "pflege-gradient-company text-white shadow-md hover:shadow-lg hover:-translate-y-0.5",
        relative: "pflege-gradient-relative text-white shadow-md hover:shadow-lg hover:-translate-y-0.5",
